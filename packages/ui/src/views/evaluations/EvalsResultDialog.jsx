                    ...
                    <Table sx={{ minWidth: 650 }}>
                        ...
                        >
                            <TableRow>
                                ...
                                <TableCell rowSpan='2'>{t('evaluations.expectedOutput')}</TableCell>
                                {dialogProps.data &&
                                ...
                                {dialogProps.data &&
                                    dialogProps.data.evaluation.chatflowId?.map((chatflowId, index) => (
                                        <React.Fragment key={index}>
                                            ...
                                            >
                                                {t('evaluations.actualOutput')}
                                            </TableCell>
                                            {dialogProps.data.customEvalsDefined && dialogProps.data.showCustomEvals && (
                                                <TableCell>{t('evaluations.evaluator')}</TableCell>
                                            )}
                                            {dialogProps.data.evaluation?.evaluationType === 'llm' && (
                                                <TableCell>{t('evaluations.llmEvaluation')}</TableCell>
                                            )}
                                        </React.Fragment>
                                    ))}
                            </TableRow>
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    <Chip
                                                                        ...
                                                                        icon={<PaidIcon />}
                                                                        size='small'
                                                                        label={`${t('evaluations.totalCost')}: ${
                                                                            item.metrics[index]?.totalCost || na
                                                                        }`}
                                                                        sx={{ mr: 1, mb: 1 }}
                                                                    />
                                                                    <Chip
                                                                        ...
                                                                        size='small'
                                                                        icon={<TokensIcon />}
                                                                        label={`${t('evaluations.totalTokens')}: ${
                                                                            item.metrics[index]?.totalTokens || na
                                                                        }`}
                                                                        sx={{ mr: 1, mb: 1 }}
                                                                    />
                                                                    {dialogProps.data.showTokenMetrics && (
                                                                        <>
                                                                            <Chip
                                                                                ...
                                                                                size='small'
                                                                                icon={<TokensIcon />}
                                                                                label={`${t('evaluations.promptTokens')}: ${
                                                                                    item.metrics[index]?.promptTokens || na
                                                                                }`}
                                                                                sx={{ mr: 1, mb: 1 }}
                                                                            />{' '}
                                                                            <Chip
                                                                                ...
                                                                                size='small'
                                                                                icon={<TokensIcon />}
                                                                                label={`${t('evaluations.completionTokens')}: ${
                                                                                    item.metrics[index]?.completionTokens || na
                                                                                }`}
                                                                                sx={{ mr: 1, mb: 1 }}
                                                                            />{' '}
                                                                        </>
                                                                    ...
                                                                    {dialogProps.data.showCostMetrics && (
                                                                        <>
                                                                            <Chip
                                                                                ...
                                                                                size='small'
                                                                                icon={<PaidIcon />}
                                                                                label={`${t('evaluations.promptCost')}: ${
                                                                                    item.metrics[index]?.promptCost || na
                                                                                }`}
                                                                                sx={{ mr: 1, mb: 1 }}
                                                                            />{' '}
                                                                            <Chip
                                                                                ...
                                                                                size='small'
                                                                                icon={<PaidIcon />}
                                                                                label={`${t('evaluations.completionCost')}: ${
                                                                                    item.metrics[index]?.completionCost || na
                                                                                }`}
                                                                                sx={{ mr: 1, mb: 1 }}
                                                                            />{' '}
                                                                        </>
                                                                    ...
                                                                    <Chip
                                                                        ...
                                                                        size='small'
                                                                        icon={<AlarmIcon />}
                                                                        label={`${t('evaluations.apiLatency')}: ${
                                                                            item.metrics[index]?.apiLatency || na
                                                                        }`}
                                                                        sx={{ mr: 1, mb: 1 }}
                                                                    />{' '}
                                                                        ...
                                                                        <>
                                                                            {item.metrics[index]?.chain && (
                                                                                <Chip
                                                                                    ...
                                                                                    size='small'
                                                                                    icon={<AlarmIcon />}
                                                                                    label={`${t('evaluations.chainLatency')}: ${
                                                                                        item.metrics[index]?.chain || na
                                                                                    }`}
                                                                                    sx={{ mr: 1, mb: 1 }}
                                                                                />
                                                                            )}{' '}
                                                                            {item.metrics[index]?.retriever && (
                                                                                <Chip
                                                                                    ...
                                                                                    size='small'
                                                                                    sx={{ mr: 1, mb: 1 }}
                                                                                    label={`${t('evaluations.retrieverLatency')}: ${
                                                                                        item.metrics[index]?.retriever
                                                                                    }`}
                                                                                />
                                                                            )}{' '}
                                                                            {item.metrics[index]?.tool && (
                                                                                <Chip
                                                                                    ...
                                                                                    size='small'
                                                                                    sx={{ mr: 1, mb: 1 }}
                                                                                    label={`${t('evaluations.toolLatency')}: ${
                                                                                        item.metrics[index]?.tool
                                                                                    }`}
                                                                                />
                                                                            )}{' '}
                                                                            <Chip
                                                                                ...
                                                                                icon={<AlarmIcon />}
                                                                                size='small'
                                                                                label={`${t('evaluations.llmLatency')}: ${
                                                                                    item.metrics[index]?.llm || na
                                                                                }`}
                                                                                sx={{ mr: 1, mb: 1 }}
                                                                            />{' '}
                                                                        </>
