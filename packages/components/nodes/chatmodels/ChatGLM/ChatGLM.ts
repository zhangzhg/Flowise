...
class ChatGLM_ChatModels implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        ...
        this.description = 'Wrapper around ZhipuAI GLM Chat Endpoints'
        ...
        this.inputs = [
            ...
            },
            {
                ...
                optional: true,
                additionalParams: true,
                description: 'Additional options to pass to the ZhipuAI client. This should be a JSON object.'
            }
        ]
    }
    ...
    loadMethods = {
        async listModels(): Promise<INodeOptionsValue[]> {
            return await getModels(MODEL_TYPE.CHAT, 'chatGLM')
        }
    }
...
module.exports = { nodeClass: ChatGLM_ChatModels }
