...
1.  构建 flowise-components（含新增的 petHelpers 导出）

```
   cd packages/components && pnpm build
```

2.  构建 flowise-pet-nodes 插件包
...
3.  在 Flowise UI → Plugins 页面点击 "Install Plugin"
    Source: local
    Path: D:\workspace\Flowise\packages\flowise-pet-nodes

4.  激活后，可从 flowise-components/Pet 目录删除 4 个 agentflow 节点源文件
